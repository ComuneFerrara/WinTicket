...
{
    public partial class XtraReportSituazioneProv : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportSituazioneProv()
        {
            InitializeComponent();
        }
        ...
        private void CreaTabellaVersamenti(Session session)
        {
            ...
            foreach (Versamento versamento in versamenti)
            {
                ...
                row.Cells[1].Text = versamento.Quietanza; //versamento.Incassi == 0 ? string.Empty : versamento.Incassi.ToString("c");
                ...
                row.Cells[2].Text = versamento.SoggettoEconomico != null ? versamento.SoggettoEconomico.RagioneSociale : string.Empty; // versamento.Pos == 0 ? string.Empty : versamento.Pos.ToString("c");
