...
{
    public partial class XtraReportSituazioneInternet : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportSituazioneInternet()
        {
            InitializeComponent();
        }
        ...
        private void CreaTabellaVersamenti(Session session)
        {
            ...
            foreach (Versamento versamento in versamenti)
            {
                ...
                else
                {
                    ...
                    totali[2] += versamento.ImportoVersato;
                    row.Cells[2].Text = versamento.ImportoVersato == 0 ? string.Empty : versamento.ImportoVersato.ToString("c");
                    row.Cells[2].TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
                    row.Cells[2].Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 5, 5, 5);
