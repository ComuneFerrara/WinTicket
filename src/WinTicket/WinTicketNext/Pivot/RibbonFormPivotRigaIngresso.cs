...
{
    public partial class RibbonFormPivotRigaIngresso : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public RibbonFormPivotRigaIngresso()
        {
            InitializeComponent();
        ...
        private GroupOperator GetNewCriteria()
        {
            ...
            if (checkEditPeriodo.Checked)
            {
                ...
                for (int anno = dateStartYear; anno <= dateEndYear; anno++)
                {
                    ...
                    rangeAndCriteria.Operands.Add(new BinaryOperator("Stampa.Vendita.DataContabile", startDate, BinaryOperatorType.GreaterOrEqual));
                    rangeAndCriteria.Operands.Add(new BinaryOperator("Stampa.Vendita.DataContabile", endDate, BinaryOperatorType.Less));
            ...
            else
            {
                ...
                newCriteria.Operands.Add(new BinaryOperator("Stampa.Vendita.DataContabile", startDate, BinaryOperatorType.GreaterOrEqual));
                newCriteria.Operands.Add(new BinaryOperator("Stampa.Vendita.DataContabile", endDate, BinaryOperatorType.Less));
            }
            ...
            if (this.checkedListBoxControl1.CheckedItems.Count > 0)
            {
                ...
                {
                    orCriteria.Operands.Add(new BinaryOperator("Ingresso.Oid", item.Oid));
                }
        ...
        private void simpleButtonQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.checkedListBoxControl1.CheckedItems.Count > 0)
                {
                    this.xpCollectionRigaIngresso.Criteria = GetNewCriteria();
                    this.xpCollectionRigaIngresso.Load();
