...
{
    public partial class XtraReportStampaMyFeAlberghi : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportStampaMyFeAlberghi()
        {
            InitializeComponent();
        }
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (this.xpCollection1.Count == 1)
            {
                ...
                if (stampa != null)
                {
                    ...
                    string descrizione = 
                    string.Format("Emesso da {0} il {1:g}. Validità {2} giorni dal primo utilizzo, per i seguenti musei:", 
